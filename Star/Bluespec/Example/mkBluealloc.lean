...
def rule_RL_do_read_index : state → (t_bool × state) :=
  fun (s : state) =>
    (bool_and (if ((s.opState == OP_READ_INDEX Unit_))
                 then BTrue Unit_
                 else BFalse Unit_) (bool_and (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index)) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index))), { { { s with bram_index := (M_mkSimpleBRAM2.meth_readA s.bram_index).avAction_ } with bram_data := (M_mkSimpleBRAM2.meth_putA s.bram_data (BFalse Unit_) (ActionValue (M_mkSimpleBRAM2.meth_readA s.bram_index) 0).avValue default).avAction_ } with opState := OP_READ_DATA Unit_ })
...
def rule_RL_do_free_lookup : state → (t_bool × state) :=
  fun (s : state) =>
    (bool_and (if ((s.opState == OP_FREE_LOOKUP Unit_))
                 then BTrue Unit_
                 else BFalse Unit_) (bool_and (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index) (bool_and (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index) (bool_and (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index)) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index)) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_data) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index)) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index))) (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_data) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index)) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_index)))))))), { { { { { s with bram_index := (M_mkSimpleBRAM2.meth_readA s.bram_index).avAction_ } with freeUnstableAddr := (ActionValue (M_mkSimpleBRAM2.meth_readA s.bram_index) 0).avValue } with bram_data := (M_mkSimpleBRAM2.meth_putB (M_mkSimpleBRAM2.meth_putA s.bram_data (BFalse Unit_) (ActionValue (M_mkSimpleBRAM2.meth_readA s.bram_index) 0).avValue default).avAction_ (BFalse Unit_) (s.enqPtr - (1 : BitVec 16)) default).avAction_ } with bram_rever := (M_mkSimpleBRAM2.meth_putA s.bram_rever (BFalse Unit_) (s.enqPtr - (1 : BitVec 16)) default).avAction_ } with opState := OP_FREE_READ Unit_ })

def rule_RL_do_free_read : state → (t_bool × state) :=
  fun (s : state) =>
    (bool_and (if ((s.opState == OP_FREE_READ Unit_))
                 then BTrue Unit_
                 else BFalse Unit_) (bool_and (M_mkSimpleBRAM2.meth_RDY_readA s.bram_data) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_readB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_data)) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_readA s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_readB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_data))) (bool_and (M_mkSimpleBRAM2.meth_RDY_readA s.bram_data) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_readB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_data)) (bool_and (M_mkSimpleBRAM2.meth_RDY_readA s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_readB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_readA s.bram_data)))))))), { { { { { { s with bram_data := (M_mkSimpleBRAM2.meth_readB (M_mkSimpleBRAM2.meth_readA s.bram_data).avAction_).avAction_ } with bram_rever := (M_mkSimpleBRAM2.meth_readA s.bram_rever).avAction_ } with freeDataAtAddr := (ActionValue (M_mkSimpleBRAM2.meth_readA s.bram_data) 0).avValue } with freeDataAtLast := (ActionValue (M_mkSimpleBRAM2.meth_readB s.bram_data) (ActionValue (M_mkSimpleBRAM2.meth_readA s.bram_data) 0).avWorld).avValue } with freeLastStable := (ActionValue (M_mkSimpleBRAM2.meth_readA s.bram_rever) (ActionValue (M_mkSimpleBRAM2.meth_readB s.bram_data) (ActionValue (M_mkSimpleBRAM2.meth_readA s.bram_data) 0).avWorld).avWorld).avValue } with opState := OP_FREE_WRITE Unit_ })

def rule_RL_do_free_write : state → (t_bool × state) :=
  fun (s : state) =>
    (bool_and (if ((s.opState == OP_FREE_WRITE Unit_))
                 then BTrue Unit_
                 else BFalse Unit_) (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data)) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data))) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data)))) (bool_and (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_index) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data))))) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_index) (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_index) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putA s.bram_rever) (bool_and (M_mkSimpleBRAM2.meth_RDY_putB s.bram_data) (M_mkSimpleBRAM2.meth_RDY_putA s.bram_data))))))))))), { { { { { s with bram_data := (M_mkSimpleBRAM2.meth_putB (M_mkSimpleBRAM2.meth_putA s.bram_data (BTrue Unit_) s.freeUnstableAddr s.freeDataAtLast).avAction_ (BTrue Unit_) (s.enqPtr - (1 : BitVec 16)) s.freeDataAtAddr).avAction_ } with bram_rever := (M_mkSimpleBRAM2.meth_putB (M_mkSimpleBRAM2.meth_putA s.bram_rever (BTrue Unit_) s.freeUnstableAddr s.freeLastStable).avAction_ (BTrue Unit_) (s.enqPtr - (1 : BitVec 16)) s.freeStableAddr).avAction_ } with bram_index := (M_mkSimpleBRAM2.meth_putB (M_mkSimpleBRAM2.meth_putA s.bram_index (BTrue Unit_) s.freeLastStable s.freeUnstableAddr).avAction_ (BTrue Unit_) s.freeStableAddr (s.enqPtr - (1 : BitVec 16))).avAction_ } with enqPtr := (s.enqPtr - (1 : BitVec 16)) } with opState := OP_IDLE Unit_ })
  ...
  fun (s : state) =>
    (bool_and (bool_and (if ((s.allocState == AL_PREFETCH Unit_))
                           then BTrue Unit_
                                                 ...
                                                 then BTrue Unit_
                                                 else BFalse Unit_)) (match _ : (bool_not (if ((s.enqPtr < s.maxEver))
                                                                                             then BTrue Unit_
                                                                                             else BFalse Unit_)) with
                                                                        | BTrue _ => BTrue Unit_
                                                                        | BFalse _ => M_mkSimpleBRAM2.meth_RDY_putB s.bram_rever), match _ : (bool_not (if ((s.enqPtr < s.maxEver))
                                                                                                                                                          then BTrue Unit_
                                                                                                                                                          else BFalse Unit_)) with
...
def rule_RL_do_alloc_wait : state → (t_bool × state) :=
  fun (s : state) =>
    (bool_and (if ((s.allocState == AL_WAIT Unit_))
                 then BTrue Unit_
                 else BFalse Unit_) (bool_and (M_mkSimpleBRAM2.meth_RDY_readB s.bram_rever) (M_mkSimpleBRAM2.meth_RDY_readB s.bram_rever)), { { { s with bram_rever := (M_mkSimpleBRAM2.meth_readB s.bram_rever).avAction_ } with allocNextStable := (ActionValue (M_mkSimpleBRAM2.meth_readB s.bram_rever) 0).avValue } with allocState := AL_READY Unit_ })
...
def meth_RDY_write_req : state → t_bool :=
  fun (s : state) =>
    bool_and (if ((s.opState == OP_IDLE Unit_))
                then BTrue Unit_
                else BFalse Unit_) (M_mkSimpleBRAM2.meth_RDY_putA s.bram_index)
